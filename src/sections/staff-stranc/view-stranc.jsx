...
export default function GetPaymentHistoryPage() {
  ...
  const fetchDetails = async () => {
    ...
    axios
      .get(`${apiRoot}/transaction/get-transaction-by-date?date=${dateFilter}`, {
        headers: {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <span>
          {parseFloat(text).toLocaleString('en-US', { style: 'currency', currency: 'VND' })}
        </span>
      ),
    },
  ];
