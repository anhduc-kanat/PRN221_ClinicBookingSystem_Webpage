        ...
        <div className="lightBg">
          <div className="container">
            <Advertising className="flexSpaceCenter">
              <AddLeft>
                <h4 className="font15 semiBold">Dedicated to each patient</h4>
                <h2 className="font40 extraBold">The smile of the patient</h2>
                <p className="font12">
                One smile is worth ten doses of tonic. Let us put a beautiful, bright smile on your face. Our services will ensure your satisfaction.
                </p>
              ...
              <AddRight>
                <AddRightInner>
                  <div className="flexNullCenter">
                    ...
                    <AddImgWrapp2>
                      <img src="./patient2.png" alt="patient2" />
                    </AddImgWrapp2>
                  </div>
                  <div className="flexNullCenter">
                    <AddImgWrapp3>
                      <img src="./patient3.png" alt="patient3" />
                    </AddImgWrapp3>
                    <AddImgWrapp4>
                      <img src="./patient4.png" alt="patient4" />
                    </AddImgWrapp4>
                  </div>
                </AddRightInner>
              </AddRight>
