      ...
      <Wrapper className="flexCenter animate whiteBg" style={y > 100 ? { height: "60px" } : { height: "80px" }}>
        <NavInner className="container flexSpaceCenter">
          ...
          <UlWrapper className="flexNullCenter">
            ...
            <li className="semiBold font15 pointer">
              <Link activeClass="active" style={{ padding: "10px 15px" }} to="/service" spy={true} smooth={true} offset={-80}>
                Service
              </Link>
            </li>
            <li className="semiBold font15 pointer">
              <Link activeClass="active" style={{ padding: "10px 15px" }} to="/price" spy={true} smooth={true} offset={-80}>
                Price
              </Link>
            </li>
            <li className="semiBold font15 pointer">
